...
public class FavoriteActivity extends AppCompatActivity implements RecyclerViewInterface {
 ...
 //creating an arraylist
        ...
        modelList.addAll(databaseHelper.readFavoritesBooks());
...
//        modelList.add(new Model("title5","author5","category5","description5",55.0,false,R.drawable.cover5));
        ...
        //adapter
        favoriteAdapter = new FavoriteAdapter(this,filteredmodelList,this);
    ...
    public void onItemClick(int position) {
            ...
            databaseHelper.removeFromFavorites(filteredmodelList.get(position).getId());
        Intent intent = new Intent(FavoriteActivity.this,FavoriteActivity.class);
        startActivity(intent);

        Toast.makeText(FavoriteActivity.this,"removed fom favorite list",Toast.LENGTH_SHORT).show();
